...
function deployContract() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const toolkit = new taquito_1.TezosToolkit('http://florence.newby.org:8732');
            toolkit.setProvider({ signer: yield signer_1.InMemorySigner.fromSecretKey('edskS6KddYkywwFvZzDtUD6H3cYFQo3VexRg8L87qrnW2GmwTGGN1CRcaJ4rneSP3fe69u9xhR3prh4ZQFgrfQ5wAF4WAk2o49') });
